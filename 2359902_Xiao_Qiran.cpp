...
/**
 * @brief Draws a feathered circle using layered transparency (decreasing radius and increasing opacity)
 * @param cx X-coordinate of the circle center
 * @param cy Y-coordinate of the circle center
 ...
 * @param p1x X-coordinate of a point the curve passes through
 * @param p1y Y-coordinate of a point the curve passes through
...
/**
 * @brief Draws decorative polygons to mask the building on the cover to form 20
 */
 ...
 * Only works when not in main scene
 ...
 * Maintains a fixed 600x800 viewport
